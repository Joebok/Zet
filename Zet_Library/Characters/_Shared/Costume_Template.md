...
Costume Role: `[Primary outfit / alternate outfit / disguise / formalwear / etc.]`
Footwear: `[boots / bare feet / sandals / shoes / etc.]`
Footwear Contact: `[How the footwear or feet should contact the ground in a neutral stance.]`
...
* Costume name: `[canonical costume name]`.
...
* Containers: `[pouches, flasks, satchels, cases, etc.; exact placement]`.
* Jewelry: `[jewelry items, colors, materials, exact visibility]`.
* Magical objects: `[allowed magical objects or explicitly none]`.
...
* Preserve `[primary costume silhouette]`.
* Preserve `[critical colors and materials]`.
* Preserve `[critical garment layers]`.
* Preserve `[critical jewelry/equipment]`.
