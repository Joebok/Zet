...
class PhaseComparisonService:
    ...
    def _slot_key(self, pipeline: str, asset: Asset) -> str:
        ...
        if pipeline in {"Head-Fitment", "Character-Assembly", "Costume-Dressing", "Expression"}:
    ...
    def _slot_label(self, pipeline: str, asset: Asset | None) -> str:
        ...
        if pipeline in {"Head-Fitment", "Character-Assembly", "Costume-Dressing", "Expression"} and asset.head_view:
