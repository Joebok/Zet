...
Depict Tsaeytte, an Youth elf female, in a neutral full-body standing pose from a FRONT_RIGHT_3_4 view. This is a new standalone illustration intended as a technical character proportion sheet.

Render the body from a front-right three-quarter body view. The torso, neck, and mannequin head all face the same front-right three-quarter direction. The head is not independently turned toward the viewer and is not looking away from the body direction.
...
Both bare feet are flat on the floor. Both heels are fully planted. Both forefeet and toes touch the ground.
No raised-foot pose.
No lifted foot.
No tiptoe stance.
No walking step.
...
Render the body in the Canonical Art Style listed above.
...
Character race/species for mannequin silhouette: elf.
...
* Use a simplified elf mannequin head.
* Long pointed elf ears should be visible as neutral mannequin geometry.
* Ear angle should preserve the character's species silhouette without adding facial identity detail.

Mannequin head negative rules:
* Do not use human rounded ears.
