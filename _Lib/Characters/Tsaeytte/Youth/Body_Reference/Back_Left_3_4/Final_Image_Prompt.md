...
Depict Tsaeytte, an Youth elf female, in a neutral full-body standing pose from a BACK_LEFT_3_4 view. This is a new standalone illustration intended as a technical character proportion sheet.

Render the body from a back-left three-quarter body view. The torso, neck, and mannequin head all face the same back-left three-quarter direction. The head is not independently turned toward the viewer and is not looking away from the body direction.
