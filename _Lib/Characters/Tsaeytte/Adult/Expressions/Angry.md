...
Expression label: Angry.
Expression intensity: clear and readable, but not caricatured.
Identity Key: {{IDENTITY_KEY_LABEL}}.
Expression definition: C:\Users\Joe\Projects\Zet\_Lib\Characters\Tsaeytte\Adult\Expressions\Angry.md.
...
Angry — intense, controlled fury.

Tsaeytte should look furious and ready to confront or retaliate. The expression should communicate sharp intensity, righteous anger, and determination without becoming a wild scream, tantrum, or caricature.

Required facial expression:
- brows drawn down and inward, creating a strong angry frown
- eyes narrowed with focused intensity
- gaze hard and directed consistently with the Identity Key view angle
- upper eyelids lowered; lower lids slightly tense
- nose may show slight flare or tension
- mouth set in a tight line or slightly parted with teeth clenched
- jaw visibly tense
- cheeks and brow carry controlled anger rather than panic or grief
- overall expression reads as angry, fierce, and ready to act

Supporting posture allowance:
- preserve the Identity Key pose category and framing
- a small amount of neck, jaw, or shoulder tension is allowed if it supports the angry expression
- do not introduce a dramatic head tilt, theatrical gesture, weapon action, or narrative action

Supporting Hair preservation allowance:
- no wisps or rumples or disarray
- hair is controled and orderly

Do not make the expression look like:
- yelling or wide-open shouting
- frantic rage or loss of control
- sadness or grief
- disgust
- generic scowl without intensity
- smug contempt or mocking anger
- embarrassed frustration

The expression should be readable as Tsaeytte specifically: fierce, sharp, controlled, and ready to act.
...
This override changes only the grooming and presentation of the canonical hairstyle for this Angry expression. It does not permit changes to hairstyle, length, silhouette, part, volume, face-framing locks, or identity.
...
- Hair is controlled.
- No wisps escape.
- Hair silhouette outline is smooth.
{{/PROMPT_INSERT}}
...
Angry-expression-specific avoidance:

* Do not make the expression a scream, cackle, roar, or open-mouth yelling pose.
* Do not make the anger look feral, monstrous, cruel, sadistic, or possessed.
* Do not replace controlled fury with generic annoyance, boredom, sadness, fear, grief, or disgust.
* Do not make her look older, harsher-featured, masculine, or villainous to show anger.
