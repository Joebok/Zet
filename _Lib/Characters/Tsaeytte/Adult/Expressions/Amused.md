...
Expression label: Amused.
Expression intensity: clear and readable, but not caricatured.
Identity Key: {{IDENTITY_KEY_LABEL}}.
Expression definition: Characters/Tsaeytte/Adult/Expressions/Amused.md.
...
Amused — warm, playful amusement.

Tsaeytte should look quietly entertained, as though she has just heard something clever, absurd, or charming. The expression should communicate alert wit, playful confidence, and friendly mischief without becoming broad comedy.

Required facial expression:
- small closed-mouth smile or very slightly parted relaxed smile
- cheeks subtly lifted
- eyes bright and engaged
- eyelids relaxed, not narrowed into suspicion
- brows relaxed, with a very slight playful lift if appropriate
- expression reads as amused, pleased, and knowingly entertained
- gaze remains consistent with the Identity Key view angle

Supporting posture allowance:
- preserve the Identity Key pose category and framing
- a very slight head softness or relaxed shoulder tension is allowed only if it supports the amused expression
- do not introduce a dramatic head tilt, theatrical hand gesture, laughing pose, or narrative action
...
- cruel mockery
- embarrassed shyness
- sadness masked by a smile
- generic neutral smile

The expression should be readable as Tsaeytte specifically: amused, clever, warm, and playfully observant.
...
- Tsaeytte looks warmly amused, clever, playful, and quietly entertained.
- The smile is controlled and characterful rather than broad, goofy, or generic.
...
- The expression becomes loud laughter, seductive flirting, smug superiority, cruel mockery, or a generic pleasant smile.
...
The final image should be a practical reusable Amused expression reference: same person, same Identity Key framing, same visible costume cues, new amused expression only.
