...
Render the character from a front-right three-quarter view. The character faces partly toward the viewer, with the character's right side more visible than the left. Do not render this as a straight front view or profile view.
