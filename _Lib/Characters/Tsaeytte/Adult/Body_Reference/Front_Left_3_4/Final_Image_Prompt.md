...
No uploaded image should be used unless explicitly attached for this job.
Generate the full image directly from the written instructions below.

Render the character from a front-left three-quarter view. The character faces forward, they do not turn their head. Do not render this as a straight front view or profile view.
...
The art-style conversion must not change view, camera angle, clothing, identity and fitment geometry,expression, age, or species.
