...
Requested view: BACK_LEFT_3_4.

Render the character from a back-left three-quarter view. The character is turned partly away from the viewer, with the character's left side more visible than the right. Do not render this as a straight back view or profile view.
