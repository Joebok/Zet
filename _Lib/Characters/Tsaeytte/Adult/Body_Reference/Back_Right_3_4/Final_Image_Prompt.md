...
Requested view: BACK_RIGHT_3_4.

Render the character from a back-right three-quarter view. The character is turned partly away from the viewer, with the character's right side more visible than the left. Do not render this as a straight back view or profile view.
