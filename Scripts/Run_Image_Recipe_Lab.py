...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run a fixed-seed local IP-Adapter recipe matrix.")
    ...
    parser.add_argument("--render-profile", default="comfyui-ipadapter-preview")
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        result = CheckpointLabService(app, PROJECT_ROOT).run_comfyui_reference_matrix(
