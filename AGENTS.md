...
Follow .github/CODEX_WORKFLOW.md. Take the next open codex-ready issue in Joebok/Zet. Claim it, implement it, run all checks, and open a ready PR. Do not merge.
