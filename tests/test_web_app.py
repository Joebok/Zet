...
""".lstrip(),
    ...
    def test_assets_page_shows_advance_all_and_removes_retired_actions(self):
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            self.assertIn("/api/prompt-evolution/comfyui-options", paths)
    ...
    def test_character_assembly_workers_resolve_refs_compile_prompt_and_stage_render(self):
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            self.assertIn("Put this head on this body.", prompt_text)
            self.assertIn("The Reference Body and Character Head already use the same direct front view.", prompt_text)
            self.assertIn("Keep the face, hair, ears, and apparent age of the head exactly as they are.", prompt_text)
            self.assertIn("Avoid assembly drift.", prompt_text)
            ...
            self.assertIn("character_template_section", source_kinds)
