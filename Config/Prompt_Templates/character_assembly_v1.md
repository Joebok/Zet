...
- The attached head-fitment image is the Character Head source.

# Assembly Task

Render one complete full-body character image.

Use the Reference Body for:
- full-body pose
- body proportions
- silhouette
- requested body view
...
Use the Character Head source for:
- head shape
- face identity
- hair silhouette
...
Place the Character Head onto the Reference Body neck connection.
Preserve the Reference Body proportions and stance.
Preserve the Character Head identity, hair, ears, and neck fit.
Render the full character in the requested costume using the character template sections below.

The Character Head MUST NOT BE ROTATED.
The Reference Body MUST NOT be re-posed.
The final image must not look like a mannequin or fitment shell.
The final image must be a complete character render, not a collage, not a cutout sheet, and not two separate images.
...
- Costume, equipment, colors, and identity anchors match the character template.
...
- Costume is omitted or replaced with tank top, shorts, underwear, generic clothing, or a mannequin covering.
