...
Depict {{CHARACTER_NAME}}, an {{CHARACTER_PHASE}} {{CHARACTER_RACE}} {{CHARACTER_GENDER}}, in a neutral full-body standing pose from a {VIEW} view. This is a new standalone illustration intended as a technical character proportion sheet.
