...
Keep the requested view recognizable and do not mirror it. Include only {{CHARACTER_NAME}} and the configured supporting subjects and objects. Do not duplicate, omit, redesign, or substitute them. Do not add scenery, effects, or unlisted props. Produce one coherent full-body reference, not a narrative scene, collage, split image, or labeled sheet.
